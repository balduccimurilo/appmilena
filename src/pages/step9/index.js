            ...
            <Paper className={classes.papers} elevation={4}>
                <Grid container direction="column" className={classes.gridgap}>
                        ...
                        <Typography className={classes.text1}>
                                    E que tal uma cantinha ? <br></br>
                                    Achou que eu ia esquecer né kkkkkk <br></br>
                                    Lá vai KKKKKKKKKKK
                        </Typography>

                        <Typography className={classes.text}>
                                    Você é como o Google. Sabe porque?<br></br>
                                    Tudo o que eu procuro, eu encontro em você.        
                        </Typography>
                   
                    <Grid container className={classes.grid}>
                        <Grid item className={classes.gridItem} xs > 

                                <Button size="small" color="#F5F1ED"  className={classes.margin} alignItems="center" component={Link} to="/step10">
